    ...
    _createClass(Mdify, null, [{
        ...
        value: function parse(input, options) {
            ...
            if (input.startsWith(options.start)) {
                var res = options.end.exec(input);
                if (res) {
        ...
        key: "writeFile",
        value: function writeFile(path, metadata, content, options, cb) {
        ...
        key: "parseFile",
        value: function parseFile(path, options, cb) {
            if (typeof options === "function") {
                cb = options;
                options = {};
            }
